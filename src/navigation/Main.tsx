                ...
                options={{
                    header: ({ route, navigation }) => (
                        <Header style={{ padding: 20, backgroundColor: "white" }}>
                            <Octicons name="arrow-left" size={30} color="rgba(0, 0, 0, 0.8)" onPress={() => navigation.goBack()} />
                            ...
                            <View>
                                ...
                                <StyledText weight="bold" size={20}>{getHeadingText(route.params?.type)}</StyledText>
                            </View>
                        </Header>
                    ),
                }}
